...
namespace KingViewClient
{
    ...
    public static class SingleInstance
    {
        ...
        public static void SaveFlagPath(string ex)
        {

            //写入日志UNDO,Exception has not been handle
            string LogFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "KingViewClientFlag.dat");
            File.WriteAllText(LogFile, ex);
        }

        public static string ReadFlagPath()
        {
            string LogFile = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "KingViewClientFlag.dat");
        ...
        public static string RunFlag
        {
            ...
            get
            {
                ...
                {
                    //KingViewClient, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
